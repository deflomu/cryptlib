...
typedef struct KI {
	...
	FNPTR_DECLARE( KEY_INIT_FUNCTION, initFunction );
	FNPTR_DECLARE( KEY_SHUTDOWN_FUNCTION, shutdownFunction );
#ifdef USE_LDAP
	FNPTR_DECLARE( KEY_GETATTRIBUTE_FUNCTION, getAttributeFunction );
	FNPTR_DECLARE( KEY_SETATTRIBUTE_FUNCTION, setAttributeFunction );
#endif /* USE_LDAP */
	FNPTR_DECLARE( KEY_GETITEM_FUNCTION, getItemFunction );
	FNPTR_DECLARE( KEY_GETSPECIALITEM_FUNCTION, getSpecialItemFunction );
	FNPTR_DECLARE( KEY_SETITEM_FUNCTION, setItemFunction );
	FNPTR_DECLARE( KEY_SETSPECIALITEM_FUNCTION, setSpecialItemFunction );
	FNPTR_DECLARE( KEY_DELETEITEM_FUNCTION, deleteItemFunction );
	FNPTR_DECLARE( KEY_GETFIRSTITEM_FUNCTION, getFirstItemFunction );
	FNPTR_DECLARE( KEY_GETNEXTITEM_FUNCTION, getNextItemFunction );
	FNPTR_DECLARE( KEY_ISBUSY_FUNCTION, isBusyFunction );
