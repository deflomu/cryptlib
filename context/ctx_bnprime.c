...
/* Define the following to convert from the fixed-format DH and ECC domain
   ...
   adding the following to the keygen function in the DH/ECDH code:

	loadDHparams( contextInfoPtr, bitsToBytes( 1536 ) );
	loadDHparams( contextInfoPtr, bitsToBytes( 2048 ) );
	loadDHparams( contextInfoPtr, bitsToBytes( 3072 ) );

	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_P256 );
	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_BRAINPOOL_P256 );
	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_P384 );
	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_BRAINPOOL_P384 );
	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_P521 );
	loadECCparams( contextInfoPtr, CRYPT_ECCCURVE_BRAINPOOL_P512 ); */
...
static int loadDHparamsFixed( INOUT CONTEXT_INFO *contextInfoPtr, 
...
static const DH_DOMAINPARAMS dh1536params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 24, FALSE, BN_FLG_STATIC_DATA, {
	...
	/* g */
	{ BIGNUM_ALLOC_WORDS, 1, FALSE, BN_FLG_STATIC_DATA, {
	0x0000000000000002ULL } },
	/* Checksums */
	0x9472AA5034F03DC6ULL, 0x28C47BE7F867ED54ULL
	};

static const DH_DOMAINPARAMS dh2048params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 32, FALSE, BN_FLG_STATIC_DATA, {
	...
	0x0000000000000002ULL } },
	/* Checksums */
	0x405BD3182D6B262CULL, 0x28C47BE7F867ED54ULL
	};

static const DH_DOMAINPARAMS dh3072params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 48, FALSE, BN_FLG_STATIC_DATA, {
	...
	0x0000000000000002ULL } },
	/* Checksums */
	0x576642F5C4CD8D96ULL, 0x28C47BE7F867ED54ULL
	};
...
static const DH_DOMAINPARAMS dh1536params = { 
	...
	{ 2 } },
	/* Checksums */
	0x7A168323, 0x847050E5
	};

static const DH_DOMAINPARAMS dh2048params = { 
	/* p */
	{ BIGNUM_ALLOC_WORDS, 64, FALSE, BN_FLG_STATIC_DATA, {
	...
	{ 2 } },
	/* Checksums */
	0x82C18653, 0x847050E5 
	};

static const DH_DOMAINPARAMS dh3072params = { 
	/* p */
	{ BIGNUM_ALLOC_WORDS, 96, FALSE, BN_FLG_STATIC_DATA, {
...
int loadDHparams( INOUT CONTEXT_INFO *contextInfoPtr, 
...
#ifdef CREATE_BIGNUM_VALUES
	checkDHdata();
	status = loadDHparamsFixed( contextInfoPtr, requestedKeySize );
	...
	/* Get the built-in DH key value that corresponds best to the client's 
	   ...
	   allow */
	domainParams = ( requestedKeySize < 192 + 8 ) ? &dh1536params : \
				   ( requestedKeySize < 256 + 8 ) ? &dh2048params : \
													&dh3072params;
...
static const ECC_DOMAINPARAMS p256params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 4, FALSE, BN_FLG_STATIC_DATA, {
...
static const ECC_DOMAINPARAMS p384params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 6, FALSE, BN_FLG_STATIC_DATA, {
...
static const ECC_DOMAINPARAMS p521params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 9, FALSE, BN_FLG_STATIC_DATA, {
	0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
	0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
	0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
	0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
...
static const ECC_DOMAINPARAMS brainpool512params = {
	/* p */
	{ BIGNUM_ALLOC_WORDS, 8, FALSE, BN_FLG_STATIC_DATA, {
...
static const ECC_DOMAINPARAMS p384params = { 
	/* p */
	{ BIGNUM_ALLOC_WORDS, 12, FALSE, BN_FLG_STATIC_DATA, {
...
static const ECC_DOMAINPARAMS p521params = { 
	/* p */
	{ BIGNUM_ALLOC_WORDS, 17, FALSE, BN_FLG_STATIC_DATA, {
	0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 
	0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 
	0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 
	0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 
...
static const ECC_DOMAINPARAMS brainpool512params = { 
	/* p */
	{ BIGNUM_ALLOC_WORDS, 16, FALSE, BN_FLG_STATIC_DATA, {
...
int loadECCparams( INOUT CONTEXT_INFO *contextInfoPtr,
	...
	/* Convert the fixed-format bignums to encoded BIGNUMs */
#ifdef CREATE_BIGNUM_VALUES
	status = loadECCparamsFixed( contextInfoPtr, curveType );
	if( cryptStatusError( status ) )
		return( status );
#endif /* CREATE_BIGNUM_VALUES */
