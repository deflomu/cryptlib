...
typedef struct SH {
	...
	FNPTR_DECLARE( SSH_HANDSHAKE_FUNCTION, beginHandshake ); 
	FNPTR_DECLARE( SSH_HANDSHAKE_FUNCTION, exchangeKeys );
	FNPTR_DECLARE( SSH_HANDSHAKE_FUNCTION, completeHandshake );
	} SSH_HANDSHAKE_INFO;
