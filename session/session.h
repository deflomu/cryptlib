...
typedef struct AL {
	...
	FNPTR_DECLARE( ATTRACCESS_FUNCTION, accessFunction );	
										/* Internal attribute access fn.*/
...
typedef struct SI {
	...
	FNPTR_DECLARE( SES_SHUTDOWN_FUNCTION, shutdownFunction );
	FNPTR_DECLARE( SES_CONNECT_FUNCTION, connectFunction );
	FNPTR_DECLARE( SES_GETATTRIBUTE_FUNCTION, getAttributeFunction );
	FNPTR_DECLARE( SES_SETATTRIBUTE_FUNCTION, setAttributeFunction );
	FNPTR_DECLARE( SES_CHECKATTRIBUTE_FUNCTION, checkAttributeFunction );
	FNPTR_DECLARE( SES_TRANSACT_FUNCTION, transactFunction );
	FNPTR_DECLARE( SES_READHEADER_FUNCTION, readHeaderFunction );
	FNPTR_DECLARE( SES_PROCESSBODY_FUNCTION, processBodyFunction );
	FNPTR_DECLARE( SES_PREPAREPACKET_FUNCTION, preparePacketFunction );
