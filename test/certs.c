...
#define ONE_YEAR_TIME	( 365 * 86400L )
  ...
  #define CERTTIME_DATETEST	( ( ( 2016 - 1970 ) * ONE_YEAR_TIME ) + 2082844800L )
  #define CERTTIME_Y2KTEST	( ( ( 2020 - 1970 ) * ONE_YEAR_TIME ) + 2082844800L )
#else
  #define CERTTIME_DATETEST	( ( 2016 - 1970 ) * ONE_YEAR_TIME )
...
int testCACert( void )
	...
	if( endTime != CERTTIME_Y2KTEST )
		{
		printf( "Warning: Certificate end time is wrong, got " TIMET_FORMAT 
				", should be %lX.\n         This is probably due to "
				"problems in the system time handling routines.\n",
