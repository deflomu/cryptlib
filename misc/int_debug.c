...
/* Under VS 2015 and newer, ImageHlp.h pulls in wincrypt.h even if
   WIN32_LEAN_AND_MEAN or NOCRYPT are defined, so we have to remove
   the canary CRYPT_MODE_ECB in order for the code to compile */
