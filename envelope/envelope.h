...
typedef struct EI {
	...
	FNPTR_DECLARE( ENV_ADDINFO_FUNCTION, addInfoFunction );
	FNPTR_DECLARE( ENV_ADDINFOSTRING_FUNCTION, addInfoStringFunction );
	FNPTR_DECLARE( ENV_CHECKMISSINGINFO_FUNCTION, checkMissingInfoFunction );
	FNPTR_DECLARE( ENV_CHECKALGO_FUNCTION, checkAlgoFunction );
	FNPTR_DECLARE( ENV_PROCESSPREAMBLE_FUNCTION, processPreambleFunction );
	FNPTR_DECLARE( ENV_PROCESSPOSTAMBLE_FUNCTION, processPostambleFunction );
	FNPTR_DECLARE( ENV_COPYTOENVELOPE_FUNCTION, copyToEnvelopeFunction );
	FNPTR_DECLARE( ENV_COPYFROMENVELOPE_FUNCTION, copyFromEnvelopeFunction );
	FNPTR_DECLARE( ENV_PROCESSEXTRADATA_FUNCTION, processExtraDataFunction );
	FNPTR_DECLARE( ENV_SYNCDEENVELOPEDATA_FUNCTION, syncDeenvelopeDataFunction );
